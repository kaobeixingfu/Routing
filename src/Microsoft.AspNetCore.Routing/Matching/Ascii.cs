...
namespace Microsoft.AspNetCore.Routing.Matching
{
    internal static class Ascii
    {
        ...
        public static bool AsciiIgnoreCaseEquals(ReadOnlySpan<char> a, ReadOnlySpan<char> b, int length)
        {
            ...
            // We're doing unsafe operations here, caller is expected to have already checked
            // length.
            ref char charA = ref MemoryMarshal.GetReference(a);
            ref char charB = ref MemoryMarshal.GetReference(b);
